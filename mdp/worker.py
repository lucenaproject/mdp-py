...
class Worker(object):
    ...
    def __init__(self, broker_url, service_name,
                 heartbeat_interval=p.DEFAULT_HEARTBEAT_INTERVAL,
                 heartbeat_timeout=p.DEFAULT_HEARTBEAT_TIMEOUT,
